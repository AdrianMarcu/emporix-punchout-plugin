...
function Credentials() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSave, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: sectionTitle, children: "Punchout Credentials" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: twoCol, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { style: { display: "block" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: fieldLabel, children: [
          "Shared Secret ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: fieldHint, children: "— leave blank to keep existing" })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { style: { display: "block" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: fieldLabel, children: "Storefront Base URL" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { ...sectionTitle, marginTop: 16 }, children: "Emporix Service Account" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: twoCol, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { style: { display: "block" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: fieldLabel, children: "Client ID" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: 14, display: "flex", alignItems: "center", gap: 10 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", style: btnPrimary, children: "Save" }),
      status && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 11, color: status.startsWith("Error") ? "#dc2626" : "#16a34a" }, children: status })
    ] })
  ] });
}
...
function BuyerMappings() {
  ...
  const [newBuyerOrgId, setNewBuyerOrgId] = reactExports.useState("");
  const [newGroupId, setNewGroupId] = reactExports.useState("");
  const [status, setStatus] = reactExports.useState("");
  reactExports.useEffect(() => {
    api.getBuyers().then((b) => setMappings(b)).catch(() => {
    });
  }, []);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: sectionTitle, children: "Buyer → Customer Group Mappings" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { style: { width: "100%", borderCollapse: "collapse", fontSize: 12 }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { style: { fontSize: 11, fontWeight: 600, color: "#888", textAlign: "left", padding: "5px 8px", borderBottom: "1px solid #e8e8e8" }, children: "Buyer Org ID" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("th", { style: { fontSize: 11, fontWeight: 600, color: "#888", textAlign: "left", padding: "5px 8px", borderBottom: "1px solid #e8e8e8" }, children: "Customer Group ID" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("tbody", { children: [
        mappings.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: 2, style: { padding: "10px 8px", color: "#aaa", fontSize: 12, fontStyle: "italic" }, children: "No mappings yet — add one below." }) }),
        mappings.map((m) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: { padding: "6px 8px", borderBottom: "1px solid #f0f0f0", color: "#333" }, children: m.buyerOrgId }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { style: { padding: "6px 8px", borderBottom: "1px solid #f0f0f0" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { display: "inline-block", padding: "1px 7px", background: "#e8f0fe", color: "#0066cc", borderRadius: 10, fontSize: 11 }, children: m.customerGroupId }) })
        ] }, m.buyerOrgId))
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleAdd, style: { display: "flex", gap: 8, alignItems: "flex-end", marginTop: 10, paddingTop: 10, borderTop: "1px solid #f0f0f0" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { style: { display: "block", flex: "0 0 200px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: fieldLabel, children: "Buyer Org ID" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            value: newBuyerOrgId,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { style: { display: "block", flex: "0 0 200px" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: fieldLabel, children: [
          "Customer Group ID ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#aaa", fontWeight: 400 }, children: "— paste from Emporix" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", style: { ...btnPrimary, marginBottom: 1 }, children: "Add" }),
      status && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { fontSize: 11, color: "#dc2626" }, children: status })
    ] })
  ] });
}
...
function ProtocolSettings() {
  const [s, setS] = reactExports.useState({ cxmlEnabled: true, ociEnabled: false, operationAllowed: "edit", ociOkCode: "ADDFROMCATALOG" });
  const [status, setStatus] = reactExports.useState("");
  reactExports.useEffect(() => {
    api.getConfig().then((cfg) => {
      const c = cfg;
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSave, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: sectionTitle, children: "Protocols" }),
    [
      { key: "cxmlEnabled", label: "cXML 1.2", sub: "SAP Ariba, Coupa, Jaggaer" },
      { key: "ociEnabled", label: "OCI 4.0", sub: "SAP SRM / SUS" }
    ].map(({ key, label, sub }) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10, padding: "7px 0", borderBottom: "1px solid #f5f5f5" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { flex: 1 }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 12, color: "#333" }, children: label }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 11, color: "#999" }, children: sub })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Toggle, { on: s[key], onChange: (v) => setS({ ...s, [key]: v }) })
    ] }, key)),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { ...sectionTitle, marginTop: 16 }, children: "Options" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: twoCol, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { style: { display: "block" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: fieldLabel, children: [
          "cXML operationAllowed ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: fieldHint, children: "— sent in PunchOutSetupResponse" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("select", { value: s.operationAllowed, onChange: (e) => setS({ ...s, operationAllowed: e.target.value }), style: selectStyle, children: ["create", "edit", "inspect"].map((v) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: v, children: v }, v)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("label", { style: { display: "block" }, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: fieldLabel, children: [
          "OCI ~OkCode ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: fieldHint, children: "— SAP field mapped on cart return" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("select", { value: s.ociOkCode, onChange: (e) => setS({ ...s, ociOkCode: e.target.value }), style: selectStyle, children: [
...
${text}`);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: sectionTitle, children: "cXML Handshake Test" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { style: { fontSize: 12, color: "#555", marginBottom: 12, lineHeight: 1.5 }, children: [
      "Sends a simulated ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("code", { style: { background: "#f5f5f5", padding: "1px 4px", borderRadius: 2, fontSize: 11 }, children: "PunchOutSetupRequest" }),
      " to verify credentials and config. Replace ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("code", { style: { background: "#fff0f0", color: "#c00", padding: "1px 4px", borderRadius: 2, fontSize: 11 }, children: "YOUR_SHARED_SECRET" }),
      " in the payload before running."
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginBottom: 12 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: runTest, disabled: loading, style: { ...btnPrimary, opacity: loading ? 0.6 : 1 }, children: loading ? "Testing…" : "Run Test" }) }),
...
function App() {
  const [tab, setTab] = reactExports.useState("Credentials");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif", maxWidth: 760, margin: "0 auto", padding: "20px 24px" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { fontSize: 13, fontWeight: 600, color: "#1a1a2e", marginBottom: 14 }, children: "Emporix Punchout Plugin" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { display: "flex", borderBottom: "1px solid #e0e0e0", marginBottom: 16 }, children: TABS.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setTab(t), style: {
      padding: "8px 14px",
      fontSize: 12,
...
export { App as A, createRoot as a, client as c, jsxRuntimeExports as j, reactExports as r, setToken as s };
