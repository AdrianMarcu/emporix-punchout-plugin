const currentImports = {};
      ...
      let moduleMap = {
"./RemoteComponent":()=>{
      dynamicLoadingCss([], false, './RemoteComponent');
      return __federation_import('/admin-ui/assets/__federation_expose_RemoteComponent-Bzqtd_nP.js').then(module =>Object.keys(module).every(item => exportSet.has(item)) ? () => module.default : () => module)},};
      const seen = {};
